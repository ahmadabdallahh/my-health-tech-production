    ...
    <nav class="flex-1 overflow-y-auto px-4">
        <ul class="space-y-2">
            ...
            <?php elseif ($is_doctor): ?>
                ...
                <li>
                    <a href="../doctor/prescriptions.php" class="flex items-center justify-between py-3 px-4 rounded-lg <?php echo get_active_class('prescriptions.php'); ?> hover:bg-gray-100 transition-colors duration-200">
            ...
            <?php elseif ($is_patient): ?>
                ...
                <li>
                    <a href="../patient/prescriptions.php" class="flex items-center justify-between py-3 px-4 rounded-lg <?php echo get_active_class('prescriptions.php'); ?> hover:bg-gray-100 transition-colors duration-200">
                        <span>الوصفات الطبية</span>
                        <i class="fas fa-file-prescription"></i>
                    </a>
                </li>
