            ...
            <div class="hidden md:flex items-center space-x-4 space-x-reverse">
                ...
                <?php if (is_logged_in()): ?>
                    <?php if ($_SESSION['user_type'] === 'patient'): ?>
                        ...
                        <a href="<?php echo $base_path; ?>patient/prescriptions.php" class="text-gray-200 hover:text-white px-3 py-2 rounded-md text-sm font-medium">روشتاتي</a>
                    <?php elseif ($_SESSION['user_type'] === 'doctor'): ?>
                        ...
                        <a href="<?php echo $base_path; ?>doctor/prescriptions.php" class="text-gray-200 hover:text-white px-3 py-2 rounded-md text-sm font-medium">الوصفات الطبية</a>
