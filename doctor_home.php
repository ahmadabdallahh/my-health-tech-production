...
// جلب بيانات الطبيب
$user_id = $user['id'];
$doctor_data = get_doctor_data($user_id);

if (!$doctor_data) {
    // Handle case where doctor profile doesn't exist yet
    // die("ملف الطبيب غير موجود");
    $doctor_id = 0;
} else {
    $doctor_id = $doctor_data['id']; // Use the REAL doctor ID for other functions
}
...
<div class="dashboard-grid">
    ...
    <div class="dashboard-card">
        ...
        <div class="quick-actions">
            ...
            <a href="doctor/prescriptions.php" class="action-btn">
