...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2025 at 09:08 PM
...
-- Procedures
--
CREATE  PROCEDURE `AddDoctorReview` (IN `p_doctor_info_id` INT, IN `p_patient_id` INT, IN `p_rating` DECIMAL(3,2), IN `p_review_text` TEXT, IN `p_treatment_date` DATE)   BEGIN
...
CREATE  PROCEDURE `BookAppointment` (IN `p_user_id` INT, IN `p_doctor_id` INT, IN `p_clinic_id` INT, IN `p_appointment_date` DATE, IN `p_appointment_time` TIME, IN `p_notes` TEXT, OUT `p_appointment_id` INT)   BEGIN
...
CREATE  PROCEDURE `GetAvailableTimes` (IN `p_doctor_id` INT, IN `p_date` DATE)   BEGIN
...
CREATE  PROCEDURE `UpdateDoctorSchedule` (IN `p_doctor_info_id` INT, IN `p_day_of_week` VARCHAR(10), IN `p_start_time` TIME, IN `p_end_time` TIME, IN `p_max_appointments` INT)   BEGIN
...
(81, 206, NULL, 50, 11, '2025-11-23', '11:00:00', 'استشارة عامة', NULL, 'cancelled', NULL, '2025-11-22 19:38:53', '2025-11-26 18:14:30'),
(85, 206, NULL, 51, 12, '2025-11-24', '12:00:00', 'استشارة عامة', NULL, 'completed', NULL, '2025-11-23 20:08:04', '2025-11-23 20:08:18'),
(86, 206, NULL, 47, 1, '2025-11-24', '12:00:00', 'استشارة عامة', NULL, 'completed', NULL, '2025-11-23 20:45:18', '2025-11-23 20:45:57'),
(87, 206, NULL, 51, 12, '2025-11-27', '12:00:00', 'استشارة عامة', NULL, 'cancelled', NULL, '2025-11-26 18:05:58', '2025-11-26 18:06:24'),
(88, 206, NULL, 51, 12, '2025-11-27', '12:30:00', 'استشارة عامة', NULL, 'completed', NULL, '2025-11-26 18:12:32', '2025-11-26 18:12:42');
...
(11, 30, 'علاج طبيعي', 4, NULL, NULL, NULL, 'علاج طبيعي ب ارخص الاسعار', NULL, 150.00, 0.00, '2025-11-22 19:00:25'),
(12, 30, 'عيادة النساء و التوليد', 2, NULL, NULL, NULL, 'نساء و توليد اطفال ', NULL, 350.00, 0.00, '2025-11-22 19:55:53');
...
(47, 'د. أحمد محمد السيد', 1, 1, 1, NULL, '01234567890', 'dr.ahmed@medical.com', 15, 'بكالوريوس الطب والجراحة - جامعة القاهرة', NULL, 4.80, 1, 250.00, NULL, '2025-11-08 12:35:56', 232, 5.00, 1),
(50, 'Hector French', 4, 11, 30, NULL, '+1 (192) 761-4091', 'hyhetopezu@email.com', NULL, NULL, NULL, 0.00, 1, 900.00, NULL, '2025-11-22 19:35:38', 245, 0.00, 0),
(51, 'احمد حسن', 2, 12, 30, NULL, '+1 (508) 709-9818', 'ahamd@hassen.com', NULL, NULL, 'assets/images/doctors/69236435401d0.jpg', 0.00, 1, 750.00, NULL, '2025-11-23 19:44:53', 247, 5.00, 1);
...
(17, 232, 206, 5, 'شغل فاخر من الاخر', 1, '2025-11-23 20:46:36', '2025-11-23 20:46:36'),
(18, 247, 206, 5, 'شغل عالي يا دكترة', 0, '2025-11-23 20:46:58', '2025-11-23 20:46:58');
...
(30, 'مستشفي احمد التخصصي', 'دمنهور - البحيرة', '01006429510', 'hospital@email.com', 'example.com', 'مركز طبي شامل', 'assets/images/hospitals/6923666561866.png', 'خاص', 4.50, 1, 1, 1, 2, '2025-11-22 18:55:38');
...
INSERT INTO `medication_logs` (`id`, `reminder_id`, `sent_at`, `status`, `channel`) VALUES
(2, 2, '2025-11-26 17:59:55', 'sent', 'push'),
(4, 2, '2025-12-13 09:37:42', 'sent', 'push');
...
INSERT INTO `medication_reminders` (`id`, `user_id`, `medication_name`, `dosage`, `frequency`, `time_of_day`, `start_date`, `end_date`, `is_active`, `created_at`, `updated_at`) VALUES
(2, 206, 'السكر', '100', 'daily', '20:02:00', '2025-11-26', '2025-11-30', 1, '2025-11-26 17:59:29', '2025-11-26 17:59:29');
...
(5, 246, '026879f7130ef137d21c54ff0c2c9f800240f978b62620760109ea2e64dbb77d', '2025-11-22 22:50:35', '2025-11-22 20:50:35', 0),
(6, 246, 'b33419f11bb6bba1549a88a9bef66f051275a1eed6002ffd6b06b00700ccb7d7', '2025-11-22 23:51:32', '2025-11-22 20:51:32', 1),
(7, 246, '89f88dac4241f0db77dc87386e9d30ff055d8149bf92d957bf56f4b0de8bf081', '2025-11-22 23:53:32', '2025-11-22 20:53:32', 0),
(8, 246, '7e87fb352967d8d4a26d23839ddfd5b8ee8869781284563f5574290571a901b3', '2025-11-22 23:54:32', '2025-11-22 20:54:32', 0),
(9, 246, 'f9b9bd8c2c86b60e0af943e820cc995aad0f1cb45949c2890c92cffc04561539', '2025-11-22 23:55:57', '2025-11-22 20:55:57', 0),
(10, 246, '2dc6a1068faf65d9041a768f6802dc27f54b2555fc4077c2f6e8f5d4fa34d182', '2025-11-22 23:57:47', '2025-11-22 20:57:47', 0);
...
INSERT INTO `prescriptions` (`id`, `appointment_id`, `doctor_id`, `patient_id`, `diagnosis`, `notes`, `created_at`, `updated_at`) VALUES
(1, NULL, 232, 206, 'سكر', '', '2025-12-13 10:40:25', '2025-12-13 10:40:25');
...
INSERT INTO `prescription_items` (`id`, `prescription_id`, `drug_name`, `dosage`, `frequency`, `duration`, `instructions`, `created_at`) VALUES
(1, 1, 'ABC', '500', 'مرتين', 'اسبوع', 'بعد الاكل ب 30 دقيقة', '2025-12-13 10:40:25');
...
INSERT INTO `push_notifications` (`id`, `user_id`, `title`, `message`, `type`, `related_id`, `action_url`, `is_read`, `created_at`) VALUES
(2, 2, 'تذكير بالموعد', 'تذكير: موعدك مع د. فاطمة أحمد حسن غداً في 2:00 مساءً', 'reminder', NULL, NULL, 0, '2025-08-10 18:49:55'),
(3, 3, 'موعد جديد', 'تم حجز موعد جديد مع د. محمد سعيد أحمد', 'appointment', NULL, NULL, 0, '2025-08-10 18:49:55'),
(4, 4, 'تحديث الموعد', 'تم تحديث موعدك مع د. سارة محمود علي', 'appointment', NULL, NULL, 1, '2025-08-10 18:49:55'),
(5, 5, 'تذكير بالموعد', 'تذكير: موعدك مع د. خالد عبد الرحمن بعد 6 ساعات', 'reminder', NULL, NULL, 0, '2025-08-10 18:49:55'),
(6, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:54:26'),
(7, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:54:26'),
(8, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:54:26'),
(9, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:54:26'),
(10, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:54:26'),
(11, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:54:26'),
(12, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:54:26'),
(13, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:54:26'),
(14, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:54:26'),
(15, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:56:06'),
(16, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:56:06'),
(17, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:56:06'),
(18, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:56:06'),
(19, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:56:06'),
(20, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:56:06'),
(21, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:56:06'),
(22, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:56:06'),
(23, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:56:06'),
(24, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:58:25'),
(25, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:58:25'),
(26, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:58:25'),
(27, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:58:25'),
(28, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:58:25'),
(29, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:58:25'),
(30, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:58:25'),
(31, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:58:25'),
(32, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 12:58:25'),
(33, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 13:05:45'),
(34, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 13:05:45'),
(35, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 13:05:45'),
(36, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 13:05:45'),
(37, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 13:05:45'),
(38, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 13:05:45'),
(39, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 13:05:45'),
(40, 3, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 13:05:45'),
(41, 4, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-08 13:05:45'),
(42, 206, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 1, '2025-11-08 13:07:28'),
(43, 206, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 1, '2025-11-08 13:08:08'),
(44, 2, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 0, '2025-11-22 19:18:59'),
(45, 2, 'Booking Confirmed', 'Your appointment has been booked.', 'appointment', NULL, NULL, 0, '2025-11-22 19:18:59'),
(46, 206, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 1, '2025-11-22 19:38:53'),
(47, 206, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 1, '2025-11-22 20:04:09'),
(48, 206, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 1, '2025-11-22 20:06:23'),
(49, 206, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 1, '2025-11-22 20:11:50'),
(50, 206, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 1, '2025-11-23 20:08:04'),
(51, 206, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 1, '2025-11-23 20:45:18'),
(52, 206, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 1, '2025-11-26 18:05:58'),
(53, 206, 'تأكيد الحجز', 'تم تأكيد حجز موعدك بنجاح', 'appointment', NULL, NULL, 1, '2025-11-26 18:12:32');
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `is_active`, `full_name`, `name`, `phone`, `specialty`, `oncall_status`, `profile_image`, `date_of_birth`, `gender`, `role`, `city_id`, `insurance_provider`, `insurance_number`, `created_at`, `updated_at`, `user_type`, `verification_code`, `is_verified`) VALUES
(2, 'fatima_patient', 'fatima@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, 'فاطمة أحمد حسن', NULL, '01012345689', 'طب عام', 'available', NULL, '1985-08-22', 'female', 'patient', 2, 'شركة التأمين المصرية', 'INS001235', '2025-08-10 18:49:54', '2025-12-04 19:30:32', 'user', NULL, 1),
(3, 'mohamed_patient', 'mohamed@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, 'محمد سعيد أحمد', NULL, '01012345690', 'طب عام', 'available', NULL, '1992-12-10', 'male', 'patient', 3, NULL, NULL, '2025-08-10 18:49:54', '2025-12-04 19:30:32', 'user', NULL, 1),
(4, 'sara_patient', 'sara@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, 'سارة محمود علي', NULL, '01012345691', 'طب عام', 'available', NULL, '1988-03-25', 'female', 'patient', 1, 'شركة التأمين المصرية', 'INS001236', '2025-08-10 18:49:54', '2025-12-04 19:30:32', 'user', NULL, 1),
(5, 'khaled_patient', 'khaled@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, 'خالد عبد الرحمن', NULL, '01012345692', 'طب عام', 'available', NULL, '1995-07-18', 'male', 'patient', 2, NULL, NULL, '2025-08-10 18:49:54', '2025-12-04 19:30:32', 'user', NULL, 1),
(11, 'cairo_hospital', 'admin@cairohospital.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, 'مستشفى القاهرة العام', NULL, '02-23658974', 'طب عام', 'available', NULL, '1980-01-01', 'male', 'hospital', 1, NULL, NULL, '2025-08-10 18:49:54', '2025-12-04 19:30:32', 'user', NULL, 1),
(12, 'maadi_hospital', 'admin@maadi-hospital.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, 'مستشفى المعادي', NULL, '02-25258963', 'طب عام', 'available', NULL, '1985-01-01', 'male', 'hospital', 1, NULL, NULL, '2025-08-10 18:49:54', '2025-12-04 19:30:32', 'user', NULL, 1),
(13, 'newcairo_hospital', 'admin@newcairo-hospital.com', '$2y$10$n37o/lQAOqIg.p/jJreEXOP/OMh0I6fZPF7rlabCEBq72G4TxoD6i.$2y$10$W1hsqqUemVTsKlm8uzOATu7WIpgxu6F3bHsc95JWUwdRqOsAWwF3S', 1, 'مستشفى مصر الجديدة', NULL, '02-24158974', 'طب عام', 'available', NULL, '1990-01-01', 'male', 'admin', 1, NULL, NULL, '2025-08-10 18:49:54', '2025-12-04 19:30:32', 'admin', NULL, 1),
(179, 'adgad.test.one', 'sadgasd@test.com', 'agsadg6654656adg###%#@daga5DGDGd', 1, 'agsasgda', NULL, '01006429510', 'طب عام', 'available', NULL, '1990-10-02', 'male', 'patient', NULL, NULL, NULL, '2025-08-16 07:49:37', '2025-12-04 19:30:32', 'patient', NULL, 1),
(181, 'ahmed.ali', 'ahmed.ali@hospital.com', 'default_password_123', 1, 'د. أحمد محمد علي', NULL, '01012345678', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-08-17 07:19:43', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(182, 'fatima.hassan', 'fatima.hassan@hospital.com', 'default_password_123', 1, 'د. فاطمة أحمد حسن', NULL, '01012345679', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-08-17 07:19:43', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(183, 'mohamed.saeed', 'mohamed.saeed@hospital.com', 'default_password_123', 1, 'د. محمد سعيد أحمد', NULL, '01012345680', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-08-17 07:19:43', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(184, 'sara.mahmoud', 'sara.mahmoud@hospital.com', 'default_password_123', 1, 'د. سارة محمود علي', NULL, '01012345681', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-08-17 07:19:43', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(185, 'khaled.abdulrahman', 'khaled.abdulrahman@hospital.com', 'default_password_123', 1, 'د. خالد عبد الرحمن', NULL, '01012345682', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-08-17 07:19:43', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(186, 'nora.ahmed', 'nora.ahmed@hospital.com', 'default_password_123', 1, 'د. نورا أحمد محمد', NULL, '01012345683', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-08-17 07:19:43', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(187, 'omar.mohamed', 'omar.mohamed@hospital.com', 'default_password_123', 1, 'د. عمر محمد حسن', NULL, '01012345684', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-08-17 07:19:43', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(188, 'layla.ahmed', 'layla.ahmed@hospital.com', 'default_password_123', 1, 'د. ليلى أحمد سعيد', NULL, '01012345685', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-08-17 07:19:43', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(189, 'youssef.mohamed', 'youssef.mohamed@hospital.com', 'default_password_123', 1, 'د. يوسف محمد علي', NULL, '01012345686', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-08-17 07:19:43', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(190, 'rana.ahmed', 'rana.ahmed@hospital.com', 'default_password_123', 1, 'د. رنا أحمد حسن', NULL, '01012345687', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-08-17 07:19:43', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(206, 'Ahmad Abdalalh', 'testt@email.com', '$2y$10$A1i.N9xPIi/SjGSfnimWIu20TJeyaiSRYifEH9OUOnHs60/SqZAQ.', 1, 'Ahmad Tech', NULL, '01006429510', 'طب عام', 'available', 'uploads/profile_images/user_206_1762604639.jpg', NULL, 'male', 'patient', NULL, NULL, NULL, '2025-11-08 11:54:35', '2025-12-04 19:30:32', 'user', NULL, 1),
(232, 'doctor_ahmed', 'dr.ahmed@medical.com', '$2y$10$eiWv24Y4oztsgBm47hmeS.LlxtTBwmyDxTieb9MxMtQSkmpLn5shm', 1, 'د. أحمد محمد السيد', NULL, NULL, 'طب عام', 'available', NULL, NULL, 'male', 'doctor', NULL, NULL, NULL, '2025-11-08 12:35:56', '2025-12-04 19:30:32', 'user', NULL, 1),
(233, 'admin', 'admin@medical.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, 'Administrator', NULL, '01000000000', 'طب عام', 'available', NULL, NULL, 'male', 'admin', NULL, NULL, NULL, '2025-11-11 17:08:21', '2025-12-04 19:30:32', 'admin', NULL, 1),
(235, 'hihil', 'hospital@email.com', '$2y$10$D0khcS9Rj3QSdpRmDoyFeuvAJj4cZkCuzwisYsfRqSMj2.0OPg76y', 1, 'مستشفي احمد التخصصي', NULL, '01006429510', 'طب عام', 'available', NULL, NULL, '', 'hospital', NULL, NULL, NULL, '2025-11-22 18:55:38', '2025-12-04 19:30:32', 'user', NULL, 1),
(245, 'hyhetopezu@email.com', 'hyhetopezu@email.com', '$2y$10$txmwRXXcNQCpnbEXRjQgTOQltd2xlisjmJvnPf/1maJPRJprhrICu', 1, 'Hector French', NULL, '+1 (192) 761-4091', 'طب عام', 'available', NULL, NULL, 'male', 'doctor', NULL, NULL, NULL, '2025-11-22 19:35:38', '2025-12-04 19:30:32', 'doctor', NULL, 1),
(246, 'myzijykol', 'kepaka2399@bablace.com', '$2y$10$SKFe8SX8HvKjXnc3ROky4OYgZYSrFnFDNfeEXJRA8lfTQIaU/47gm', 1, 'Camille Gray', NULL, '01006429580', 'طب عام', 'available', NULL, NULL, 'male', 'patient', NULL, NULL, NULL, '2025-11-22 20:41:08', '2025-12-04 19:30:32', 'user', NULL, 1),
(247, 'ahamd@hassen.com', 'ahamd@hassen.com', '$2y$10$jnWrMcB2A5whbERRuU0c4u6O3M2.FVAJTNDpx7CgDmRMzR0Cbo1Py', 1, 'احمد حسن', NULL, '+1 (508) 709-9818', 'طب عام', 'available', NULL, NULL, 'male', 'doctor', NULL, NULL, NULL, '2025-11-23 19:44:53', '2025-12-04 19:30:32', 'doctor', NULL, 1);
...
ALTER TABLE `appointment_reviews`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_appointment_review` (`appointment_id`,`user_id`),
...
ALTER TABLE `prescription_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_items_prescription` (`prescription_id`);
...
--
ALTER TABLE `medication_logs`
  ADD CONSTRAINT `medication_logs_ibfk_1` FOREIGN KEY (`reminder_id`) REFERENCES `medication_reminders` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `prescriptions`
  ADD CONSTRAINT `fk_prescriptions_appointment` FOREIGN KEY (`appointment_id`) REFERENCES `appointments` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_prescriptions_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_prescriptions_patient` FOREIGN KEY (`patient_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `prescription_items`
--
ALTER TABLE `prescription_items`
  ADD CONSTRAINT `fk_items_prescription` FOREIGN KEY (`prescription_id`) REFERENCES `prescriptions` (`id`) ON DELETE CASCADE;
