                                            ...
                                            <tr class="bg-white border-b hover:bg-gray-50 transition-colors duration-150">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="flex items-center text-gray-600">
                                                        ...
                                                        <span class="break-all"><?php echo htmlspecialchars($doctor['email']); ?></span>
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4">
                                                    <span class="px-3 py-1.5 text-xs font-semibold leading-tight rounded-full <?php echo $status_class; ?> inline-flex items-center whitespace-nowrap">
                                ...
                                ?>
                                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                        ...
                                        <div class="flex items-center mb-3">
                                            <i class="fas fa-user-md text-blue-400 text-2xl ml-2"></i>
                                            <h4 class="font-bold text-gray-900 text-lg"><?php echo htmlspecialchars($doctor['full_name']); ?></h4>
                                        </div>

                                        <!-- Specialization -->
                                        <div class="flex items-center mb-2">
                                            <i class="fas fa-stethoscope text-gray-400 ml-2"></i>
                                            <span class="text-gray-600 text-sm"><?php echo htmlspecialchars($doctor['specialization'] ?? 'غير محدد'); ?></span>
                                        </div>

                                        <!-- Email -->
                                        <div class="flex items-start mb-2">
                                            <i class="fas fa-envelope text-gray-400 ml-2 mt-1"></i>
                                            <span class="text-gray-600 text-sm break-all"><?php echo htmlspecialchars($doctor['email']); ?></span>
                                        </div>
                                        ...
                                        <div class="pt-3 border-t border-gray-300">
                                            <form method="POST" action="manage_doctors.php" class="mb-2">
                                                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                                                <input type="hidden" name="user_id" value="<?php echo $doctor['user_id']; ?>">
                                            ...
                                            <form method="POST" action="manage_doctors.php" onsubmit="return confirm('هل أنت متأكد من رغبتك في حذف هذا الطبيب؟ سيتم حذف حسابه بالكامل.');">
                                                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                                                <input type="hidden" name="user_id" value="<?php echo $doctor['user_id']; ?>">
                                                <input type="hidden" name="delete_doctor" value="1">
