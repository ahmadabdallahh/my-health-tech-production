...
<body class="bg-gray-50">
        ...
        <aside id="sidebar" class="w-64 bg-white shadow-xl h-screen sticky top-16 hidden lg:block">
            <div class="p-4">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="prescriptions.php" class="flex items-center space-x-3 space-x-reverse p-3 rounded-lg hover:bg-gray-50 text-gray-700">
    ...
    <!-- Mobile Sidebar -->
    <div id="mobileSidebar" class="fixed inset-y-0 right-0 w-64 bg-white shadow-xl transform translate-x-full lg:translate-x-full lg:hidden z-40 transition-transform duration-300 ease-in-out">
        <div class="p-4">
            <ul class="space-y-2">
                <li>
                    <a href="index.php" class="flex items-center space-x-3 space-x-reverse p-3 rounded-lg bg-blue-50 text-blue-600 font-medium">
                ...
                <li>
                    <a href="prescriptions.php" class="flex items-center space-x-3 space-x-reverse p-3 rounded-lg text-gray-700 hover:bg-gray-100">
                        <i class="fas fa-file-prescription w-5"></i>
                        <span>الوصفات الطبية</span>
                    </a>
                </li>
                <li>
                    <a href="../search.php" class="flex items-center space-x-3 space-x-reverse p-3 rounded-lg text-gray-700 hover:bg-gray-100">
                        <i class="fas fa-search w-5"></i>
                        <span>البحث عن طبيب</span>
                    </a>
                </li>
                <li>
                    <a href="../doctors.php" class="flex items-center space-x-3 space-x-reverse p-3 rounded-lg text-gray-700 hover:bg-gray-100">
                        <i class="fas fa-user-md w-5"></i>
                        <span>الأطباء</span>
                    </a>
                </li>
                <li>
                    <a href="../hospitals.php" class="flex items-center space-x-3 space-x-reverse p-3 rounded-lg text-gray-700 hover:bg-gray-100">
                        <i class="fas fa-hospital w-5"></i>
                        <span>المستشفيات</span>
                    </a>
                </li>
    ...
    <script>
        ...
        const menuItems = document.querySelectorAll('#mobileSidebar a');
